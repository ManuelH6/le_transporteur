...
class _NewOrderFormPageState extends State<NewOrderFormPage> {
  ...
  final _destDistrictController = TextEditingController();
  ...
  void dispose() {
    ...
    _destDistrictController.dispose();
  ...
  void _submitOrder() async {
    ...
    final pickupLieu = _isManualPickup 
        ? Lieu(adresse: "${_pickupStreetController.text}, ${_pickupDistrictController.text}, ${_pickupCityController.text}, Bénin", lat: 0, lng: 0)
        : (_selectedPickup ?? Lieu(adresse: _pickupAddressController.text, lat: 0, lng: 0));
        
    final destLieu = _isManualDest
        ? Lieu(adresse: "${_destStreetController.text}, ${_destDistrictController.text}, ${_destCityController.text}, Bénin", lat: 0, lng: 0)
    ...
    try {
      ...
      final pickupDistrict = _isManualPickup ? _pickupDistrictController.text : getPart(pickupParts, 3, pickupCity);
      final destCity = _isManualDest ? _destCityController.text : getPart(destParts, 2, 'Cotonou');
      final destDistrict = _isManualDest ? _destDistrictController.text : getPart(destParts, 3, destCity);
      ...
      final payload = {
        ...
        'scheduledAt': _isScheduled ? _scheduledAt?.toUtc().toIso8601String() : null,
      };
            ...
            child: Column(
              children: [
                AppTextField(
                  ...
                  hintText: 'Contact sur place (Nom)',
                  ...
                  Column(
                    children: [
                      _buildManualAddressFields(
                        ...
                        districtController: _pickupDistrictController,
              ...
              children: [
                ...
                if (!_isManualDest)
                  ...
                  _buildManualAddressFields(
                    ...
                    districtController: _destDistrictController,
  ...
  Widget _buildManualAddressFields({
    ...
    return Column(
      children: [
        AppTextField(
          controller: TextEditingController(text: 'Bénin'),
          hintText: 'Pays',
        ...
        DropdownButtonFormField<String>(
          ...
          decoration: InputDecoration(
            hintText: 'Ville',
            prefixIcon: Icon(Icons.location_city, color: Colors.grey[400], size: 20.sp),
            filled: true,
        ...
        AppTextField(
          ...
          hintText: 'Quartier (ex: Fidjrossè)',
          prefixIcon: Icons.holiday_village_outlined,
          validator: (val) => val == null || val.isEmpty ? 'Veuillez saisir le quartier' : null,
        ),
        SizedBox(height: 12.h),
        AppTextField(
          controller: streetController,
          hintText: 'Rue / Maison / Détails précis',
          prefixIcon: Icons.signpost_outlined,
          validator: (val) => val == null || val.isEmpty ? 'Veuillez saisir les détails de l\'adresse' : null,
        ),
      ],
    );
  }
